...
`npx skills add scando1993/sugar` installs for any supported agent. Platform-specific: `npx skills add scando1993/sugar -a cursor`. Superpowers requires manual file copying per platform.
...
One-command install: `npx skills add scando1993/sugar -a <platform>`
