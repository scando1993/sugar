...
const allSteps: {
  ...
  { id: '7',  label: 'Phase 3b — PRD Generation',  description: 'execution.md · prd.json · CLAUDE.md · VERIFY.md · ralph-loop.sh (via sugar generate)', phase: 'generation' },
  { id: '8',  label: 'Phase 3c — Launch',          description: 'sugar run <workspace> for each group in parallel',           phase: 'execution' },
  { id: '9',  label: 'Read prd.json + progress.txt', description: 'Check Codebase Patterns section first',               phase: 'ralph' },
  { id: '10', label: 'Pick next story',            description: 'LoopRunner picks highest priority pending/rejected, claims it',                  phase: 'ralph' },
  ...
  { id: '18', label: 'Verifier quorum votes',       description: 'VOTE:PASS/FAIL tallied by ConsensusEngine',             phase: 'ralph' },
  { id: '19', label: 'Commit on consensus PASS',    description: 'feat: US-001 - verified by consensus · status: passed', phase: 'ralph' },
  ...
  { id: '22', label: 'Exit: complete or stuck',    description: 'No push — that stays a separate, explicit step',        phase: 'ralph' },
