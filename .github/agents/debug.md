---
name: debug
description: "Systematic debugging with hypothesis-driven investigation. Phases: Reproduce → Hypothesize → Investigate → Fix → Verify → Regression."
tools:
  - "read"
  - "edit"
  - "search"
...
Debug [user's bug description] using the following systematic approach.
