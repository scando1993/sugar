---
name: debug
description: "Systematic debugging with hypothesis-driven investigation. Use when diagnosing bugs, errors, or unexpected behavior. Phases: Reproduce → Hypothesize → Investigate → Fix → Verify → Regression."
user-invocable: true
---
...
## 3-Fix Escalation Protocol

When the iron law triggers (>= 3 fixes tried):
...
3. **Check scope** — is the bug in the code you're looking at, or in a dependency/environment?
